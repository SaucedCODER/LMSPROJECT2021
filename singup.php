...
<body>
  <div class="container min-vh-100 d-flex justify-content-between align-items-center">
    <h1 class="text-center">Create an account</h1>

    <form class="signup-form border ">
      ...
      <div class="form-group mb-2">
        <input type="text" class="form-control" id="official-address" placeholder="Official Address" />
      </div>
      <div class="form-group mb-2">
        <input type="tel" class="form-control" id="mobile-no" placeholder="Mobile Number" />
      </div>
      <div class="form-group mb-2">
        <input type="tel" class="form-control" id="landline-no" placeholder="Landline Number" />
      </div>
      <div class="form-group mb-2">
